...
import { idlFactory } from './todo_crud_frontend.did.js';
export { idlFactory } from './todo_crud_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.TODO_CRUD_FRONTEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./todo_crud_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the todo_crud_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./todo_crud_frontend.did.js")._SERVICE>}
 */
export const todo_crud_frontend = createActor(canisterId);
